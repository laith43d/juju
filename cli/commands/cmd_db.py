...
#               '-p', 'databases/migrations', '--table', table, '--create'])
#     elif table:
#         call(['python', 'db.py', 'make:migration', migration_name,
...
#     :return: None
#     """
#     call(['python', 'db.py', 'migrate:refresh', '-p', 'databases/migrations', '-f'])
#
#
# @cli.command()
# def migrate():
...
#     :return:
#     """
#     call(['python', 'db.py', 'migrate', '-p', 'databases/migrations', '-f'])
#
#
...
#     :return: None
#     """
#     call(['python', 'db.py', 'migrate:reset', '-p', 'databases/migrations', '-f'])
#
#
...
#     :return: None
#     """
#     call(['python', 'db.py', 'migrate:rollback', '-p', 'databases/migrations', '-f'])
#
#
...
#     :return: None
#     """
#     call(['python', 'db.py', 'make:seed', '-p', 'databases/seeds', seed_name])
#
#
...
#     :return: None
#     """
#     call(['python', 'db.py', 'db:seed', '-p', 'databases/seeds', seed_name])
#
#
...
def make_model(model_name: str):
    ...
    if not os.path.isfile(f'models/{model_name.capitalize()}.py'):
        ...
        with open(f'models/{model_name.capitalize()}.py', 'w') as f:
            f.write('from config.settings import BaseModel, M\n')
            f.write('from sqlalchemy import Column, Integer, DateTime\n')
            f.write('import datetime\n\n\n')
            f.write(f'''
class {model_name.capitalize()}(M, BaseModel):\n
